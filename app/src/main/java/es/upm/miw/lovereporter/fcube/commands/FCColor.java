...
public class FCColor implements IFeedbackCubeCommnads {
    ...
    private String sColorRed_DECIMAL;
    private String sColorGreen_DECIMAL;
    private String sColorBlue_DECIMAL;


    public FCColor(String sIp, String sRedDecimal, String sGreenDecimal, String sBlueDecimal) {
        this.ipAdress = sIp;
        this.sColorRed_DECIMAL = sRedDecimal;
        this.sColorGreen_DECIMAL = sGreenDecimal;
        this.sColorBlue_DECIMAL = sBlueDecimal;
    }
